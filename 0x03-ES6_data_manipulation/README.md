...
The project's objectives tasks is  to learn:
1. use map, filter and reduce on arrays: Understand how these array methods work and when to use them.
2. Typed arrays: Learn about typed arrays in JavaScript and their use cases.
3. The Set, Map, and Weak link data structures: Explore these data structures and their differences.
...
2. Install Jest, Babel, and ESLint: In your project directory, install Jest, Babel, and ESLint using the supplied package.json

Don’t forget to run npm install once you have the package.json.
