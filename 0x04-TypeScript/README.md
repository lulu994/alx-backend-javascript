...
This project demonstrates TypeScript concepts related to basic types, interfaces, classes, DOM manipulation, generic types, and namespaces. It includes a simple student information display using Vanilla JavaScript.

### Learning Objectives

By the end of this project, you will be able to explain the following topics without relying on external resources:

1. **Basic Types in TypeScript:** Understand TypeScript’s basic data types.
2. **Interfaces, Classes, and Functions:** Learn how to define interfaces, create classes, and work with functions.
3. **DOM Manipulation with TypeScript:** Use TypeScript to interact with the Document Object Model (DOM).
4. **Generic Types:** Explore the concept of generic types in TypeScript.
5. **Namespaces:** Organize your code using namespaces.

### Resources

  - [Typescript in 5 mins](https://intranet.alxswe.com/rltoken/waTSa9Mguj912pel9On57w)
  - [Typescript Documentation](https://intranet.alxswe.com/rltoken/iPO8DlHCGzc1jnojLoP9HA)

### Running the Project

1. Ensure you have Node.js and npm installed.
2. Clone the GitHub repository: alx-backend-javascript
3. Navigate to the directory.
4. Install dependencies: npm install
5. Compile TypeScript files: npx tsc
6. Run the project: Open index.html in your browser.
...
+ 0. **Creating an interface for a student**<br/>[task_0/js/main.ts](task_0/js/main.ts) contains a script that meets the following requirements:
...
+ 1. **Let's build a Teacher interface**<br/>[task_1/js/main.ts](task_1/js/main.ts) contains a script that meets the following requirements:
...
+ 2. **Extending the Teacher class**<br/>[task_1/js/main.ts](task_1/js/main.ts) contains the following updates:
  + Write an interface named `Directors` that extends `Teacher`. It requires an attribute named `numberOfReports(number)`.

+ 3. **Printing teachers**<br/>[task_1/js/main.ts](task_1/js/main.ts) contains the following updates:
...
+  4. **Writing a class**<br/>[task_1/js/main.ts](task_1/js/main.ts) contains the following updates:
...
+ 5. **Advanced types Part 1**<br/>[task_2/js/main.ts](task_2/js/main.ts) contains a script that meets the following requirements:
...
+ 6. **Creating functions specific to employees**<br/>[task_2/js/main.ts](task_2/js/main.ts) contains the following updates:
...
+ 7. **String literal types**<br/>[task_2/js/main.ts](task_2/js/main.ts) contains the following updates:
...
+ 10. **Update task_4/js/main.ts**<br/>[task_4/js/main.ts](task_4/js/main.ts) contains the following updates:
...
+ 11. **Brand convention & Nominal typing**<br/>[task_5/js/main.ts](task_5/js/main.ts) contains a script that meets the following requirements:
