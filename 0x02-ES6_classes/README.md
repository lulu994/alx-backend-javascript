...
In this project you are learning how to define and add methods to a class, Why and how to add a static method to a class, How to extend a class from another and Metaprogramming and symbols in JavaScript.
...
- Configuration for Babel (if needed).

3. .eslintrc.js:

- ESLint configuration for linting your code.

Don’t forget to run npm install after setting up the package.json.
